defmodule Mix.Tasks.ExAppInfo.Version.Set.Major do
  @moduledoc """
  Set the MAJOR version in the project version with the given argument.
  ```
  Usage: mix ex_app_info.version.set.major NEW_VERSION
  ```
  ...
  # task properties
  @shortdoc "set the project MAJOR version"
  ...
  defp update_version_data(raw_new_version, opts \\ []) do
    with {:ok, {old_version, new_version}} <- ExAppInfo.update_version_part(:major, raw_new_version, opts),
