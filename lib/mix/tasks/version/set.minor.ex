defmodule Mix.Tasks.ExAppInfo.Version.Set.Minor do
@moduledoc """
  Set the MINOR version in the project version with the given argument.
  ```
  Usage: mix ex_app_info.version.set.minor NEW_VERSION
  ```
  ...
  # task properties
  @shortdoc "set the project MINOR version"
  ...
  defp update_version_data(raw_new_version, opts \\ []) do
    with {:ok, {old_version, new_version}} <- ExAppInfo.update_version_part(:minor, raw_new_version, opts),
